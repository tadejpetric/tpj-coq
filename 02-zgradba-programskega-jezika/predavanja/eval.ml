...
let rec eval_exp env =
    ...
    | Syntax.Int n -> n
    | Syntax.Plus (exp1, exp2) -> eval_exp env exp1 + eval_exp env exp2
    | Syntax.Minus (exp1, exp2) -> eval_exp env exp1 - eval_exp env exp2
    | Syntax.Times (exp1, exp2) -> eval_exp env exp1 * eval_exp env exp2
